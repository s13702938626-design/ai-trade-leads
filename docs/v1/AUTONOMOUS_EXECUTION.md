...
| 2 Rollback and recovery | completed | pending commit | Added soft-delete rollback and original-ID recovery import. |
| 3 Migration workflow | in_progress | - | Add guarded API and complete migration UI. |
