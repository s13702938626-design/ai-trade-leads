...
| 3 Migration workflow | completed | pending commit | Added local guarded migration preflight, decision, import, and rollback APIs. |
| 4 Opportunity model | in_progress | - | Add domain tables and repositories. |
